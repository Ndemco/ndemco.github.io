...
layout: post
title: CI/CDogma
subtitle: When Continuous Deployment Becomes Performative Engineering
---

Somewhere along the way, CI/CD stopped being an engineering decision and started being a personality trait.

Teams brag about deployment frequency like it’s a proxy for competence. Blog posts imply that if you aren’t shipping ten times a day, you’re doing software development *wrong*. Companies announce they’re “moving to CI/CD” with the same energy they announce their next half-baked AI feature.

This is backwards.

CI/CD is neither good nor bad. It’s not a rite of passage, a maturity badge, or proof that your engineering org has “made it.” It’s a solution to a very specific set of problems that arise under very specific conditions. Treating it as a universal best practice is how you end up with fast pipelines delivering bad software more efficiently than ever.
...
- The team is staffed with relatively inexpensive (but aptly paid) engineers  
...
Companies like Netflix, Google, and Amazon thrive in CI/CD environments for a simple reason: they invest heavily in engineering talent.
...
There’s another critical reason CI/CD works so well at high-performing companies that almost never gets discussed: **they embrace specialization and deep domain ownership.**

Consider an engineer named Jesse.

Jesse is exceptional. He questions assumptions. He sweats the details. He writes elegant solutions to genuinely hard problems. Jesse is part of a team that owns four services, and for the last five years, most of his day-to-day work has lived inside those same four codebases.

He knows them intimately—the strengths, the weaknesses, the tech debt, the failure modes. You can’t run `git blame` on those repositories without seeing Jesse’s name everywhere.

When Jesse gets a feature request, he already knows how he’s going to implement it before he opens an editor. Not because he’s psychic, but because he understands the system deeply. He understands the domain.

Give Jesse the power to push directly to production, and he thrives. CI/CD works beautifully here—not because of the pipeline, but because of the expertise behind it.
...
## CI/CD Assumes Domain Mastery

CI/CD is not just a bet on individual competence. It’s a bet on **deep familiarity with the system being changed**.
...
At this point, someone usually waves the DORA metrics around like a trump card.
...
Those teams tend to be staffed with strong engineers. They tend to have good ownership models. They tend to understand their systems deeply. They tend to write safer changes. They tend to know how to recover when things go wrong. In other words, they have already earned the right to move fast.
...
DORA doesn’t say “deploy often and you’ll be great.”  
It observes that great teams *can* deploy often without slowly degrading their systems.
...
There is nothing wrong with slower, more deliberate workflows. Manual QA. Staged releases. Longer review cycles. Explicit release windows. For many teams, these produce better software with fewer surprises. Stability is a feature. Predictability is a feature. Shipping less often does not make you a worse engineer.
...
It’s a tool. Use it when it makes sense. Skip it when it doesn’t.
